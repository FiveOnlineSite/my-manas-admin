...
const HowToApply = () => {
  ...
  const fetchData = async () => {
    setLoading(true)
    const res = await getRequest("/academy/how-to-apply");
    if (res.success) {
      setData(res.data);
    } else {
    }
  ...
  const onSubmit = async () => {
    ...
    try {
      if (editId !== null) {
        ...
        const res = await postRequest("/academy/how-to-apply", formData);
        if (res.success) {
  ...
  const onDeleteClick = async (id) => {
    const res = await deleteRequest(`/academy/how-to-apply/${id}`);
    if (res.success) {
          ...
          <ModalBody>
            ...
            <div className='p-2'>
              ...
              <Form className='row gy-4' onSubmit={handleSubmit(onSubmit)}>
                <Col md='12'>
                  <label className='form-label'>WhatsApp Number <span className="danger">*</span></label>
                  <input
          ...
          <ModalBody className='text-center'>
            ...
            <div className='d-flex justify-content-center gap-2 mt-4'>
              <Button
                ...
                className='p-3'
                onClick={async () => {
                  const res = await deleteRequest(`/academy/how-to-apply/${deleteId}`);
                  if (res.success) {
                    toast.success("Deleted successfully");
                    fetchData();
                  } else {
